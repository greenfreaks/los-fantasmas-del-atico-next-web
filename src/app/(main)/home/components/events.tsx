        ...
        {EVENT_LIST.map((event, index) => {
          ...
          return (
            <div
              key={index}
              /* 
                - flex-1: permite que el contenedor crezca y ocupe el espacio sobrante de la fila.
                - basis-full sm:basis-[calc(50%-1rem)] lg:basis-[calc(33.333%-1rem)]: 
                  Garantiza que entren máximo 3 por fila en pantallas grandes.
              */
              className="flex-1 basis-full md:basis-[calc(50%-1rem)] lg:basis-[calc(33.333%-1rem)] flex border-2 p-5 rounded-3xl gap-x-6 min-w-[280px]"
            >
              {/* Bloque Fecha */}
              <div className="bg-main w-32 flex flex-col justify-center items-center rounded-md font-oswald text-light-white uppercase p-3 shrink-0 min-w-[90px]">
              ...
              <div className="flex flex-col justify-between">
                <div className="uppercase">
                  <h3 className="font-oswald text-title-3 text-light-white">
                    {event.name}
                  </h3>
